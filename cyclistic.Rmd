...
![](C:/data_science/Portfolio/Case_Study_1_Bike_Share/cyclistic/images/i1_logo.png)
...
## 4.3 - Pre-exploring and discovering percentile of missing values
...
## 4.4 - Adapting database for study

### 4.4.1 - Filtering not relevant variables
...
### 4.4.2 - Adding relevant variables 
...
### 4.4.4 - Checking out and removing used data
```{r}
...
## 4.4.5.2 - Investigating the percentile from total
```{r}
...
## 4.4.5.4 - Checking out the results and the NAs percentile
```{r}
...
### 5.1.1 Using only variables to this study
```{r}
...
### 5.1.2 Exploring data by tables
...
### 5.2.1 Using only variables to this study
```{r}
...
### 5.2.2 Exploring data by tables
...
### 6.3.1 - Stations where Members and Casuals most unlock bikes
...
## 7.1 - Recommendation I - Convert assertively

**To design an annual plan for weekend users**
...
**To be assertive in the marketing strategy**
...
**To establish a good trade between cost and benefit**

With this action, a good part of Casuals riders will be more loyal and this means lower investment in marketing and more profit. But, this have to be not just more economic than the other annual plan, but a win-win relationship with the client and must be clear to the client's understanding. 
...
* Create partnerships with commerce along the maritime coast, like earn discount by being a Member; and
...
**To keep up a great job of bicycle logistics**
...
## 7.2 - Recommendation II - Data-driven decision making culture

**Know more to improve loyalty**
...
**To increase engagement through the app**

A good and practice way to get data is through the company's app. Incentives to keep them moving, such as a monthly goal would be an excellent strategy.

## 7.3 - Recommendation III - Increase Loyalty

**To create a loyalty plan for Members**
...
* At five hundred covered miles earns 40 Ciclystic Points; 
* At thousand covered miles earns 80 Ciclystic Points;

Friends indication points

* At three Indication for any annual plan earns 160 Ciclystic Points (after payment confirmation);
* At six Indication for any annual plan earns 200 Ciclystic Points (after payment confirmation);
...
**To create a discount system for annual plan renewal**
